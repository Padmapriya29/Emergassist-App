...
export default class MicrolearningTab extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      CourseName: this.props.navigation.getParam("details")["Course_name"],
      CourseImage: "#",
  ...
  getReceiverDetails = () => {
    ...
    db.collection("requested_Courses")
      ...
      .then((snapshot) => {
        snapshot.forEach((doc) => {
          this.setState({
            ...
            CourseImage: doc.data().image_link,
          });
        });
      });
  };
  ...
  addNotification = () => {
    var message =
      this.state.userName + " has shown interest in donating the Course";
